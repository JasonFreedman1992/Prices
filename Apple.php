        ...
        <table class="pure-table pure-table-bordered submenu-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="submenu-price-field"><input name="iphone11screenrepair" class="submenu-table-input iphoneinputs" type="text" disabled value="<?php echo $iphone11screenrepair ?>" disabled /></td>
