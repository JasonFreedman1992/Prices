...
function appleSubMenu(){
    ...
    <div class="submenu-wrapper">
        ...
        <div class="submenu-heading">
            <label style="margin-bottom: 10.4px;display: inline-block;">Unlock</label>
        ...
        <table class="pure-table pure-table-bordered submenu-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="submenu-price-field"><input class="submenu-table-input" disabled type="text" value="<?php echo $iphoneXscreenrepair ?>" /></td>
