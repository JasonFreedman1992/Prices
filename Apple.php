        ...
        <table class="pure-table pure-table-bordered submenu-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="submenu-price-field"><input onfocus="onFocus(this)" onfocusout="onFocusOut(this)"  maxlength="4" name="iphone11screenrepair" class="submenu-table-input iphoneinputs" type="text" readonly value="<?php echo $iphone11screenrepair ?>" /></td>
                    <td class="submenu-price-field"><input onfocus="onFocus(this)" onfocusout="onFocusOut(this)"  maxlength="4" name="iphone11proscreenrepair" class="submenu-table-input iphoneinputs" type="text" readonly value="<?php echo $iphone11proscreenrepair ?>" /></td>
                    <td class="submenu-price-field"><input onfocus="onFocus(this)" onfocusout="onFocusOut(this)"  maxlength="4" name="iphone11promaxscreenrepair" class="submenu-table-input iphoneinputs" type="text" readonly value="<?php echo $iphone11promaxscreenrepair ?>" /></td>
                    <td class="submenu-price-field"><input onfocus="onFocus(this)" onfocusout="onFocusOut(this)"  maxlength="4" name="iphonexsscreenrepair" class="submenu-table-input iphoneinputs" type="text" readonly value="<?php echo $iphonexsscreenrepair ?>"  /></td>
                    <td class="submenu-price-field"><input onfocus="onFocus(this)" onfocusout="onFocusOut(this)"  maxlength="4" name="iphonexsmaxscreenrepair" class="submenu-table-input iphoneinputs" type="text" readonly value="<?php echo $iphonexsmaxscreenrepair ?>"  /></td>
                </tr>
                <tr>
